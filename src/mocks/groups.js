...
export const LOC_AMOUNT_GROUP = 'LOC';
export const COMPLEXITY_OPTIONS_AMOUNT_GROUP = 'complexity options amoint'
export const NOVELTY_CATEGORY_GROUP = 'degree of novelty';
